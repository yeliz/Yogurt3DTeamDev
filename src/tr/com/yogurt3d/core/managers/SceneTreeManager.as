...
/*		public static function getRenSetIlluminatorLightIndexes(_scene:IScene, _renderableChild:SceneObjectRenderable):Vector.<int>
		...
		public static function initIntersectedLightByCamera(_scene:IScene, _activeCamera:Camera3D):void
		{
		...
		public static function getScene(_sceneObject:SceneObject):IScene
		{
		...
		public static function clearSceneFrameData( _scene:IScene, _camera:Camera3D ):void{
		...
		public static function getSceneRenderableSet(_scene:IScene, _camera:Camera3D):Vector.<SceneObjectRenderable>
		{
		...
		public static function getSceneCameraSet(_scene:IScene):Vector.<Camera3D>
		{
		...
		private static function addCameraChildIntoSceneSet(_cameraChild:Camera3D, _scene:IScene):void
		{
		...
		private static function removeCameraChildFromSceneSet(_cameraChild:Camera3D, _scene:IScene):void
		{
			var _camerasByScene	:Vector.<Camera3D> 	= s_cameraObjectsByScene[_scene];
