package tr.com.yogurt3d.core.scene
{
	...
	public class SceneObjectRenderable extends SceneObject
	{
		...
		public function onAddedToSceneGraph(_child:SceneObject, _scene:IScene):void{
			$registerMaterial();
		}
		public function onRemovedFromSceneGraph(_child:SceneObject, _scene:IScene):void{
			$unregisterMaterial();
		}
